...
@app.route('/usuario/<id_usuario>/cliente/<id_cliente>/facturas', methods = ['GET'])
...
#Inserción Encabezado de una factura
@app.route('/usuario/<id_usuario>/cliente/<id_cliente>/nuevafactura', methods = ['POST'])
def insertarEncabezadoFactura(id_usuario, id_cliente):
    try:
